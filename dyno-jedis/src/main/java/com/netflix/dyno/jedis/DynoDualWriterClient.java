...
public class DynoDualWriterClient extends DynoJedisClient {
    ...
    public OperationResult<Long> d_append(final String key, final String value) {
        writeAsync(key, () -> shadowClient.d_append(key, value));
    ...
    public OperationResult<String> d_hmset(final String key, final Map<String, String> hash) {
        writeAsync(key, () -> shadowClient.d_hmset(key, hash));
    ...
    public OperationResult<Long> d_sadd(final String key, final String... members) {
        writeAsync(key, () -> shadowClient.d_sadd(key, members));
    ...
    public OperationResult<Long> d_hset(final String key, final String field, final String value) {
        writeAsync(key, () -> shadowClient.d_hset(key, field, value));
    ...
    public OperationResult<String> d_set(final String key, final String value) {
        writeAsync(key, () -> shadowClient.d_set(key, value));
    ...
    public OperationResult<String> d_setex(final String key, final Integer seconds, final String value) {
        writeAsync(key, () -> shadowClient.d_setex(key, seconds, value));
    ...
    public Long del(final String key) {
        writeAsync(key, () -> shadowClient.d_del(key));
    ...
    public Long expire(final String key, final int seconds) {
        writeAsync(key, () -> shadowClient.d_expire(key, seconds));
    ...
    public Long expireAt(final String key, final long unixTime) {
        writeAsync(key, () -> shadowClient.d_expireAt(key, unixTime));
    ...
    public String getSet(final String key, final String value) {
        writeAsync(key, () -> shadowClient.d_getSet(key, value));
    ...
    public Long hdel(final String key, final String... fields) {
        writeAsync(key, () -> shadowClient.d_hdel(key, fields));
    ...
    public Long hincrBy(final String key, final String field, final long value) {
        writeAsync(key, () -> shadowClient.d_hincrBy(key, field, value));
    ...
    public Double hincrByFloat(final String key, final String field, final double value) {
        writeAsync(key, () -> shadowClient.d_hincrByFloat(key, field, value));
    ...
    public Long hsetnx(final String key, final String field, final String value) {
        writeAsync(key, () -> shadowClient.d_hsetnx(key, field, value));
    ...
    public Long incr(final String key) {
        writeAsync(key, () -> shadowClient.d_incr(key));
    ...
    public Long incrBy(final String key, final long delta) {
        writeAsync(key, () -> shadowClient.d_incrBy(key, delta));
    ...
    public Double incrByFloat(final String key, final double increment) {
        writeAsync(key, () -> shadowClient.d_incrByFloat(key, increment));
    ...
    public String lpop(final String key) {
        writeAsync(key, () -> shadowClient.d_lpop(key));
    ...
    public Long lpush(final String key, final String... values) {
        writeAsync(key, () -> shadowClient.d_lpush(key, values));
    ...
    public Long lrem(final String key, final long count, final String value) {
        writeAsync(key, () -> shadowClient.d_lrem(key, count, value));
    ...
    public String lset(final String key, final long count, final String value) {
        writeAsync(key, () -> shadowClient.d_lset(key, count, value));
    ...
    public String ltrim(final String key, final long start, final long end) {
        writeAsync(key, () -> shadowClient.d_ltrim(key, start, end));
    ...
    public Long persist(final String key) {
        writeAsync(key, () -> shadowClient.d_persist(key));
    ...
    public Long pexpireAt(final String key, final long millisecondsTimestamp) {
        writeAsync(key, () -> shadowClient.d_pexpireAt(key, millisecondsTimestamp));
    ...
    public Long pttl(final String key) {
        writeAsync(key, () -> shadowClient.d_pttl(key));
    ...
    public String rename(final String oldkey, final String newkey) {
        writeAsync(oldkey, () -> shadowClient.d_rename(oldkey, oldkey));
    ...
    public String rpop(final String key) {
        writeAsync(key, () -> shadowClient.d_rpop(key));
    ...
    public Long scard(final String key) {
        writeAsync(key, () -> shadowClient.d_scard(key));
    ...
    public Boolean setbit(final String key, final long offset, final boolean value) {
        writeAsync(key, () -> shadowClient.d_setbit(key, offset, value));
    ...
    public Long setnx(final String key, final String value) {
        writeAsync(key, () -> shadowClient.d_setnx(key, value));
    ...
    public Long setrange(final String key, final long offset, final String value) {
        writeAsync(key, () -> shadowClient.d_setrange(key, offset, value));
    ...
    public Set<String> smembers(final String key) {
        writeAsync(key, () -> shadowClient.d_smembers(key));
    ...
    public Long smove(final String srckey, final String dstkey, final String member) {
        writeAsync(srckey, () -> shadowClient.d_smove(srckey, dstkey, member));
    ...
    public List<String> sort(final String key) {
        writeAsync(key, () -> shadowClient.d_sort(key));
    ...
    public String spop(final String key) {
        writeAsync(key, () -> shadowClient.d_spop(key));
    ...
    public Long srem(final String key, final String... members) {
        writeAsync(key, () -> shadowClient.d_srem(key, members));
    ...
    public ScanResult<String> sscan(final String key, final String cursor) {
        writeAsync(key, () -> shadowClient.d_sscan(key, cursor));
    ...
    public ScanResult<String> sscan(final String key, final String cursor, final ScanParams params) {
        writeAsync(key, () -> shadowClient.d_sscan(key, cursor, params));
    ...
    public Long ttl(final String key) {
        writeAsync(key, () -> shadowClient.d_ttl(key));
    ...
    public Long zadd(final String key, final double score, final String member) {
        writeAsync(key, () -> shadowClient.d_zadd(key, score, member));
    ...
    public Long zadd(final String key, final Map<String, Double> scoreMembers) {
        writeAsync(key, () -> shadowClient.d_zadd(key, scoreMembers));
    ...
    public Double zincrby(final String key, final double score, final String member) {
        writeAsync(key, () -> shadowClient.d_zincrby(key, score, member));
    ...
    public Long zrem(final String key, final String... member) {
        writeAsync(key, () -> shadowClient.d_zrem(key, member));
    ...
    public List<String> blpop(final int timeout, final String key) {
        writeAsync(key, () -> shadowClient.d_blpop(timeout, key));
    ...
    public List<String> brpop(final int timeout, final String key) {
        writeAsync(key, () -> shadowClient.d_brpop(timeout, key));
